<script type="text/javascript">
	...
	//Kota
	function tampilKota() {
		$.get("<?php echo site_url('Kota/tampil'); ?>", function(data) {
			MyTable.fnDestroy();
			$('#data-kota').html(data);
			refresh();
		});
	...
	$(document).on("click", ".update-dataKota", function() {
		...
		$.ajax({
			method: "POST",
			url: "<?php echo site_url('Kota/update'); ?>",
			data: "id=" +id
		})
		.done(function(data) {
	...
	$(document).on("click", ".detail-dataKota", function() {
		...
		$.ajax({
			method: "POST",
			url: "<?php echo site_url('Kota/detail'); ?>",
			data: "id=" +id
		})
		.done(function(data) {
			$('#tempat-modal').html(data);
	...
	$('#form-tambah-kota').submit(function(e) {
		...
		$.ajax({
			method: 'POST',
			url: "<?php echo site_url('Kota/prosesTambah'); ?>",
			data: data
		})
		.done(function(data) {
	...
	$(document).on('submit', '#form-update-kota', function(e){
		...
		$.ajax({
			method: 'POST',
			url: "<?php echo site_url('Kota/prosesUpdate'); ?>",
			data: data
		})
		.done(function(data) {
			var out = jQuery.parseJSON(data);
